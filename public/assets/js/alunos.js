...
async function showDeleteAlunoPopUp(e) { 
    ...
    const nome = e.target.closest("tr").querySelector("td.td-aluno").innerText
...
function handleNota(e){
    ...
    nota_nova = Math.min(Math.max(nota_nova, 0), 10);
    e.target.value = nota_nova
                        ...
                        render: function(data, type, row, meta) {
                            return `
                                <div class="d-flex gap-1 justify-content-end">
                                    ...
                                    <a href="/notas/gerar_pdf/${row.id}" target="_blank">
